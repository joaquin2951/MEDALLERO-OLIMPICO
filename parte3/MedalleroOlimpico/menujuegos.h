...
void ordenarGrupo(int grupo[197][2], const int cfilas); //funcion para ordenar vectores de medallero
void mostrarGrupo(int grupo[197][2], const int cfilas,short coordX,short coordY);//funcion creada para mostrar los grupos como lista
void generarTop(int mat_Top[197][2], int mat_deporteMedallas[87][3]);
